...
config.read('clabbersconfig.cfg')
...
#    print(move)
    ...
    effectivemovescore = movefeatures[i][7] #raw score
    if movefeatures[i][1] > (7-movefeatures[i][1]):
        effectivemovescore += (10*movefeatures[i][11]) #if we can draw a full rack, then keeping a blank is good
    effectivemovescore += (50*movefeatures[i][12]) # probability of bingoing in the next move
